...
def main():
    ...
    # Build X_train
    x_train = data_train.iloc[:, [1,3,5,6]].values
    print("X train: ")
    print(x_train)
    print("\n")
    ...
    # Build X_test
    x_test = data_test.iloc[:, [1,3,5,6]].values
    print("X test: ")
    print(x_test)
    print("\n")
    ...
    print("[0, 3, 0, 1, 0, 7] - 1:")
    print(classifier.predict_proba([[0, 0, 1, 0]]))
    print("\n[10, 0, 0, 2, 0, 10] - 0:")
    print(classifier.predict_proba([[10, 0, 2, 0]]))
